    ...
    <div className="h-screen flex flex-col bg-gray-100">
      <header className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-3 sm:p-4 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          {/* Backend Status */}
          <div className="flex items-center space-x-2 text-xs sm:text-sm px-2 py-1 rounded-full font-medium">
            {/* Dot */}
            <div
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Content *{" "}
            <span className="text-gray-500 text-xs">(min 20 words)</span>
          </label>
          <textarea
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-6">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setNewNote({ ...newNote, reviewDays: parseInt(e.target.value) })
              }
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={(e) =>
                setNewNote({
                  ...newNote,
                  useSemanticChunking: e.target.checked,
                })
              }
              className="mr-2"
            />
            <label htmlFor="semantic" className="text-sm text-gray-700"> Semantic chunking
            </label>
          </div>
        </div>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6 bg-purple-50 p-4 sm:p-6 rounded-lg border-2 border-purple-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {concepts.key_concepts.map((concept, idx) => (
              ...
              >
                <div className="font-semibold text-sm sm:text-base text-purple-700">
                  {concept.concept}
                </div>
                ...
                <div className="text-xs text-gray-600 mt-2 line-clamp-2">
                  {concept.example_context.substring(0, 80)}...
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
        <h3 className="text-xs sm:text-sm font-semibold text-gray-600 mb-2 sm:mb-3 uppercase">
          Content
        </h3>
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-4 sm:space-y-6">
        {currentTest?.questions?.map((q, idx) => (
          <div
            key={idx}
            className="bg-white p-4 sm:p-6 rounded-lg border-2 border-gray-200 shadow-sm"
          >
            ...
            {q.type === "mcq" && q.options ? (
              <div className="space-y-2">
                {q.options.map((option, i) => (
                  <label
                    key={i}
                    className="flex items-start p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-blue-50 transition-colors"
                  >
                    <input
                      type="radio"
                      name={`q${idx}`}
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-2">
                  ...
                  <span className="text-lg sm:text-xl font-bold mt-1 sm:mt-0">
                    {result.score}%
                  </span>
                </div>
